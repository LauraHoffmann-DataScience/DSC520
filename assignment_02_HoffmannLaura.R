...
# Use `setwd()` if needed
setwd("~/RStudio/PROJECTS/GithubProjects/dsc520")
...
voter_turnout_df1 <- readxl::read_excel("data/G04ResultsDetail2004-11-02.xls", sheet = "Voter Turnout", skip = 2)
...
column_names = c("ward_precinct", "ballots_cast", "registered_voters", "voter_turnouts")
voter_turnout_df2 <- readxl::read_excel("data/G04ResultsDetail2004-11-02.xls", sheet = 
                                        "Voter Turnout", skip = 2, col_names = column_names)
...
jsonlite::toJSON(scores_df, pretty = TRUE)
